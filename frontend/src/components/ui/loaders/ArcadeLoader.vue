...
.loader::after {
  ...
  height: 60px;
  background:
   linear-gradient(90deg, currentColor 4px, transparent 0 calc(100% - 4px), currentColor 0) bottom / 22px 20px,
   linear-gradient(90deg, red 4px, transparent 0 calc(100% - 4px), red 0) bottom 10px left 0 / 22px 6px,
   linear-gradient(currentColor 0 0) bottom 3px left 0 / 22px 8px,
   linear-gradient(currentColor 0 0) bottom 0 left 50% / 8px 16px;
  background-repeat: no-repeat;
